...
### Feature roadmap ###
* TODO: Produce `"error"="Unknown"` when Tracy event in not-aftered
* TODO: Support for `component` label

### 2.0.2-SNAPSHOT ###
* DONE: Implemented Tracy.annotate(String intName, int intValue) for user convenience
* DONE: Allow for user defined optIds - Tracy.setOptId("U001")
* DONE: Add safety upon exception thrown unit test

...
### 3.2.0-SNAPSHOT ###
* Added setHttpResponseAnnotation(String key) and getHttpResponseAnnotations() implementation allowing to send annotations to Client via X-Tracy-Annotations HTTTP header
